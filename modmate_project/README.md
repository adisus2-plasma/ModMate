...
โปรเจกต์ Thesis-204 — แอปพลิเคชันผู้ช่วยออกกำลังกายบนมือถือที่รวมการคำนวณ BMI/BMR/TDEE, คลังท่าออกกำลังกายแบบวิดีโอ และโหมด **AR (Augmented Reality)** สำหรับแสดงท่าทางในรูปแบบ 3 มิติด้วย ARKit
